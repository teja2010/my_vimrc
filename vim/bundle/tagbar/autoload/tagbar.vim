...
function! s:InitTypes() abort
    ...
    " Go {{{3
    let type_golang = s:TypeInfo.New()
    let type_golang.ctagstype = 'go'
    let type_golang.kinds = [
          \  { 'short' : 'p', 'long' : 'package', 'fold' : 0, 'stl' : 1},
          \  { 'short' : 'i', 'long' : 'imports', 'fold' : 0, 'stl' : 1},
          \  { 'short' : 'c', 'long' : 'constants', 'fold' : 0, 'stl' : 1},
          \  { 'short' : 'v', 'long' : 'variables', 'fold' : 0, 'stl' : 1},
          \  { 'short' : 't', 'long' : 'types', 'fold' : 0, 'stl' : 1},
          \  { 'short' : 'n', 'long' : 'interfaces', 'fold' : 0, 'stl' : 1},
          \  { 'short' : 'w', 'long' : 'fields', 'fold' : 0, 'stl' : 1},
          \  { 'short' : 'e', 'long' : 'embedded', 'fold' : 0, 'stl' : 1},
          \  { 'short' : 'm', 'long' : 'methods', 'fold' : 0, 'stl' : 1},
          \  { 'short' : 'r', 'long' : 'constructor', 'fold' : 0, 'stl' : 1},
          \  { 'short' : 'f', 'long' : 'functions', 'fold' : 0, 'stl' : 1}
          \ ]
    let type_golang.sro = '.'
    let type_golang.kind2scope = {
          \ 't' : 'ctype',
          \ 'n' : 'ntype'
          \ }
    let type_golang.scope2kind = {
          \ 'ctype' : 't',
          \ 'ntype' : 'n'
          \ }
    "let type_golang.ctagsargs = '-sort -silent'
    let s:known_types[type_golang.ctagstype] = type_golang
...
function! s:TypeInfo.createKinddict() abort dict
    let i = 0
    call s:LogDebugMessage(">>>" . self.ctagstype ."")
    for kind in self.kinds
        call s:LogDebugMessage("?" . self.ctagstype . " kind '" . kind.short . "'")
